      ...
      <p
        className={cn(
          ...
          params?.channelid == channel.id &&
            "text-primary gark:text-zinc-200 dark:group-hover:text-white"
        )}
      >
        {channel.name}
      </p>
      {channel.name != "general" && role != MemberRole.GUEST && (
        <div className="ml-auto flex items-center gap-x-4">
          <ActionTooltip label="Edit">
            <Edit className="hidden group-hover:block w-4 h-4 text-zinc-400 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 transition"/>
          </ActionTooltip>
          <ActionTooltip label="Edit">
            <Trash className="hidden group-hover:block w-4 h-4 text-zinc-400 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 transition"/>
          </ActionTooltip>
        </div>
      )}
